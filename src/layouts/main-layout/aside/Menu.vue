<template>
  ...
  >
    ...
    <div
      ...
      data-kt-menu="true"
    >
      <!-- Super Admin Start local menu -->
      <template v-if="isLogedOn()">
        <template v-for="(item, i) in OnlyAdminMenuConfig" :key="i">
...
import OnlyAdminMenuConfig from "@/core/config/OnlyAdminMenuConfig";
